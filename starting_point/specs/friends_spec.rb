...
def test_likes_to_eat__false
  result = likes_to_eat(@person2, "spinach")
...
def test_money_lending
  money_lending(@person1, @person2, 1)
  result = @person1[:monies]
  result2 = @person2[:monies]
